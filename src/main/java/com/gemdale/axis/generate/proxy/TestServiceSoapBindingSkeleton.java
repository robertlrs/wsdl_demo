...
public class TestServiceSoapBindingSkeleton implements TestService, org.apache.axis.wsdl.Skeleton {
    private TestService impl;
    ...
    */
    ...
    static {
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), String.class, false, false),
        };
    ...
    public TestServiceSoapBindingSkeleton() {
        this.impl = new TestServiceSoapBindingImpl();
    }

    public TestServiceSoapBindingSkeleton(TestService impl) {
        this.impl = impl;
    }
    public String desc() throws java.rmi.RemoteException
    {
        String ret = impl.desc();
        return ret;
    }

    public String setDesc(String in0) throws java.rmi.RemoteException
    {
        String ret = impl.setDesc(in0);
        return ret;
    }
